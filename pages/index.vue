      ...
      <VCol cols="12" md="6" lg="6" sm="6">
        <VRow no-gutters align="center" justify="center">
          <VCol cols="12" md="6" class="pa-3">
            ...
            <VForm class="mt-7">
              <div class="mt-1">
                <VTextField label="Email" variant="outlined" prepend-inner-icon="mdi-email" id="email" name="email"
                  type="email" />
              </div>
              <div class="mt-1">
                <VTextField label="Password" variant="outlined" prepend-inner-icon="mdi-lock" id="password"
            ...
            <p class="text-center mt-10">
              ...
              <NuxtLink class="text-primary">Register</NuxtLink>
            </p>
          </VCol>
        </VRow>
      </VCol>
